...
pairs = [
    ...
    (roles.org_exec, Permission(action="event.create_event", resource="*")),
    (roles.org_exec, Permission(action="event.get_event", resource="*")),
    (roles.org_exec, Permission(action="event.update_event", resource="*"))
